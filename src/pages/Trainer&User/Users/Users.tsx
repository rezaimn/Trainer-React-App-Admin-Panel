...
import {initialState, IProps, IState} from './UsersContainer'
...
class Users extends Component<IProps, IState> {
    ...
    render() {
        ...
        const {item, isShowDeleteModal} = this.state;
        return (
            <div className="animated fadeIn">

                <Row>
                    <Col>
                        <CSVLink filename='Customers_List.csv' className="csv-btn"
                                 data={
                                     users &&
                                        ...
                                        <tr key={item.id.toString()}>
                                            ...
                                            <td>
                                                <Link className="fa fa-lg fa-edit action-icon"
                                                      to={`/admin/user/edit/${item.id}`}></Link>
